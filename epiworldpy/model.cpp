...
static void update_exposed_impl(Agent<int> *p, Model<int> *m) {
  ...
  m->array_double_tmp[1] = 1.0 - (1.0 - virus->get_prob_recovery(m)) *
...
void epiworldpy::export_model(py::class_<epiworld::Model<int>> &c) {
  c.def(py::init<>(), "Create a new empty model.")
      ...
      .def("run_multiple", &run_multiple,
           "Run the model multiple times according to the previously "
           "specific parameters.",
...
void epiworldpy::export_all_models(pybind11::module &m) {
  ...
  export_model_<epimodels::ModelSIR<int>>(
      sir, "SIR", make_arg<std::string>("name"), make_arg<double>("prevalence"),
      make_arg<double>("transmission_rate"), make_arg<double>("recovery_rate"));
  ...
  export_model_<epimodels::ModelSIS<int>>(
      sis, "SIS", make_arg<std::string>("name"), make_arg<double>("prevalence"),
      make_arg<double>("transmission_rate"), make_arg<double>("recovery_rate"));
