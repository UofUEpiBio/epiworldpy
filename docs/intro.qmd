...
This Python package is a wrapper of the C++ library [epiworld][epiworld].
It provides a general framework for modeling disease transmission using
agent-based models. Some of the main features include:
...
see the API documentation page [on the website][api].

[epiworld]: https://github.com/UofUEpiBio/epiworld
[api]: https://uofuepibio.github.io/epiworldpy
